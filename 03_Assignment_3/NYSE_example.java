...
public class NYSE_example {   //changin here too the values from LongWritable to FloatWritable
...
//                trade_price.set(Float.parseFloat(tokens[2])); index from 2 to 6
                trade_price.set(Float.parseFloat(tokens[6]));
...
//            output.collect(key, new LongWritable(MaxPrice));
    ...
    public static void main(String[] args) throws Exception {
        JobConf conf = new JobConf(NYSE_example.class);
        conf.setJobName("NYSE");
